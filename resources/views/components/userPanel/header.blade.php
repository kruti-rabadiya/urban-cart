<header>
    <nav>
                ...
                <div class="ham-links">
                    <div class="ham-nav-home ham-link-box">
                        <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink"
                            version="1.1"  width="800px" height="800px" viewBox="0 0 34 32"
                            enable-background="new 0 0 34 32" xml:space="preserve" fill="#000000">
                ...
                <div class="ham-links">
                    <div class="ham-nav-order ham-link-box">
                        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1024 1024"
                            fill="currentColor" class="icon" version="1.1" stroke="currentColor" stroke-width="0.5">
                            <path 
                    ...
                    <div class="ham-nav-wishlist ham-link-box">
                        <svg xmlns="http://www.w3.org/2000/svg" width="800px" height="800px" viewBox="0 0 58 58"
        ...
        <div class="nav-icons">
            <a href="/search" class="mobile-search"><img class="nav-icon search-icon"
                    src="/svgs/search-icon-nav.svg" alt="Search"></a>
